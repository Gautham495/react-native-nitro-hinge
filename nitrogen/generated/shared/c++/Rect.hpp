...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::nitrohinge::Rect> final {
    static inline margelo::nitro::nitrohinge::Rect fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitrohinge::Rect(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitrohinge::Rect& arg) {
