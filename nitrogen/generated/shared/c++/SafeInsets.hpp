...
namespace margelo::nitro::nitrohinge {
  ...
  /**
   * A struct which can be represented as a JavaScript object (SafeInsets).
   */
  ...
  public:
    SafeInsets() = default;
    explicit SafeInsets(double top, double right, double bottom, double left): top(top), right(right), bottom(bottom), left(left) {}

  public:
    friend bool operator==(const SafeInsets& lhs, const SafeInsets& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ SafeInsets <> JS SafeInsets (object)
  template <>
  struct JSIConverter<margelo::nitro::nitrohinge::SafeInsets> final {
    static inline margelo::nitro::nitrohinge::SafeInsets fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitrohinge::SafeInsets(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitrohinge::SafeInsets& arg) {
