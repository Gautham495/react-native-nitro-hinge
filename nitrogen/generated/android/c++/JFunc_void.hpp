...
namespace margelo::nitro::nitrohinge {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitrohinge/Func_void;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitrohinge/Func_void_cxx;";
