...
/**
 * Represents the JavaScript object/struct "SafeInsets".
 */
@DoNotStrip
@Keep
data class SafeInsets(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is SafeInsets) return false
  ...
  companion object {
    ...
    @Suppress("unused")
    @JvmStatic
    private fun fromCpp(top: Double, right: Double, bottom: Double, left: Double): SafeInsets {
      return SafeInsets(top, right, bottom, left)
    }
  }
}
